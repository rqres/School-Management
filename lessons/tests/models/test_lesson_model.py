...
class LessonTest(TestCase):
    ...
    #     # localizing these datetimes to avoid warnings
    #     self.lesson = Lesson(
    #         name=f"{self.student.user.first_name}{self.teacher.user.last_name}Guitar1",
    #         description="Gutitar lesson on basics",
    #         startTime=pytz.utc.localize(datetime(2022, 11, 10, 10, 0, 0)),
    #         endTime=pytz.utc.localize(datetime(2022, 11, 10, 11, 0, 0)),
    #     )
    ...
    #         startTime=pytz.utc.localize(datetime(2022, 11, 11, 10, 0, 0)),
    #         endTime=pytz.utc.localize(datetime(2022, 11, 11, 11, 0, 0)),
    #     )
    ...
    #     self.lesson.startTime = pytz.utc.localize(datetime(2022, 11, 10, 11, 0, 0))
    #     self.lesson.endTime = pytz.utc.localize(datetime(2022, 11, 10, 10, 0, 0))

    #     self._assert_lesson_is_invalid()

    # def test_invalid_long_length_of_lesson(self):
    #     self.lesson.startTime = pytz.utc.localize(datetime(2022, 11, 10, 10, 0, 0))
    #     self.lesson.endTime = pytz.utc.localize(datetime(2022, 11, 10, 12, 0, 0))
    #     self._assert_lesson_is_invalid()

    # def test_invalid_short_length_of_lesson(self):
    #     self.lesson.startTime = pytz.utc.localize(datetime(2022, 11, 10, 10, 0, 0))
    #     self.lesson.endTime = pytz.utc.localize(datetime(2022, 11, 10, 10, 20, 0))
    #     self._assert_lesson_is_invalid()
